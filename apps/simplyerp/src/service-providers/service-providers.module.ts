...
@Module({ 
  ...
  providers: [ServiceProvidersGateway, ServiceProvidersService,BeautyServiceService, SocketService, UsersService,SearchService,JwtService ,UserWalletsService, SalesOrdersService],
  controllers: [
